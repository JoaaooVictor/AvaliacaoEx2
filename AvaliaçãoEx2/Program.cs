        ...
        static void Main(string[] args)
            {
                ...
                Console.WriteLine("Olá, escolha uma das cidades abaixo de acordo com sua numeração:\n\n1 - ATIBAIA \n2 - BRAGANÇA PAULISTA \n3 - MAIRIPORÃ \n4 - NAZARÉ \n5 - TERRA PRETA \n6 - EXTREMA \n7 - VARGEM");
                Console.WriteLine("----------------------------------");
                cidade = Convert.ToInt32(Console.ReadLine());
            if (cidade < 1 || cidade > 7)
            {
                Console.WriteLine("Digite um valor válido para as cidades.");
                Console.ReadKey();
            }
            else
            {
